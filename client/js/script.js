...
class AppComponent extends React.Component {
  ...
  render() {
    ...
    if (this.state.sidebar === "side-bar") {
      ...
      navBar = <div className={this.state.sidebar} style={ { height: this.state.height } }><h1>Welcome {this.state.user.displayName}</h1>
      <p>This is an app designed around food pairing. Press Enter to start exploring new custom recipies today!</p>
      <div className="start-button" onClick={() => { this.moveToSideBar(); }}>Enter</div>
      </div>;
    }
