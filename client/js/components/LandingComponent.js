  ...
  class LandingComponent extends React.Component {
    ...
    render() {
      ...
      if (this.state.display !== false) {
        landingContent = <div className="vertical-alignment"><h1>Create and activate a <ReactRouter.Link to={"/CreateDiet"}>diet</ReactRouter.Link></h1>
